...
from app.models.student import Student, Grade, StudentStatus, UserRole
...
class StudentService:
    ...
    def login_admin(self, phone: str, password: str) -> dict[str, str]:
        ...
        Returns:
            Dict with access token and admin info.

        Raises:
            AuthenticationError: If credentials are invalid or user is not admin.
        """
        student = student_repository.get_by_phone(phone)
        ...
        if not student.is_admin():
            raise AuthenticationError("该账户不是管理员")
